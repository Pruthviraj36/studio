  ...
  return (
    <ResponsiveContainer maxWidth="xl" padding="px-4 py-4">
      <Tabs defaultValue="discover">
        <div
          className={
            isMobile ? "space-y-4" : "flex items-center justify-between mb-8"
          }
        >
          <TabsList className={isMobile ? "w-full" : ""}>
            <TabsTrigger value="discover" className={isMobile ? "flex-1" : ""}>
              Discover Teams
            </TabsTrigger>
            <TabsTrigger value="my-teams" className={isMobile ? "flex-1" : ""}>
              My Teams
            </TabsTrigger>
          </TabsList>
          ...
          <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
            ...
            <DialogContent
              className={isMobile ? "w-[95vw]" : "sm:max-w-[425px]"}
            >
              <DialogHeader>
                <DialogTitle>Create a New Team</DialogTitle>
                <DialogDescription>
                  Assemble your dream team and start building the next big
                  thing.
                </DialogDescription>
              </DialogHeader>
              <MobileForm onSubmit={handleCreateTeam}>
                ...
                <div
                  className={
                    isMobile ? "flex gap-2 mt-6" : "flex justify-end gap-4 mt-6"
                  }
                >
                  <Button
                    type="button"
