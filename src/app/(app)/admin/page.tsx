...
export default function AdminPage() {
    ...
    try {
      if (editingHackathon) {
        ...
        toast({
          ...
          description: "New hackathon added successfully.",
        });
      }
  ...
  const handleDeleteUser = async (id: string) => {
    ...
    if (
      confirm(
        "Are you sure you want to delete this user? This action is permanent and only removes their profile data.",
      )
    ) {
      try {
        await deleteUser(id);
    ...
    <ResponsiveContainer maxWidth="xl" padding="px-4 py-4">
      <div className="space-y-6">
        <div className="flex flex-col gap-2">
          <h1
            className={`font-headline tracking-tight ${isMobile ? "text-2xl" : "text-3xl"} font-bold`}
          >
            Admin Dashboard
          </h1>
        ...
        <div
          className={`grid gap-4 ${isMobile ? "grid-cols-2" : "md:grid-cols-2 lg:grid-cols-4"}`}
        >
            ...
            <Card className="bg-white/20 dark:bg-black/20 backdrop-blur-md">
              <CardHeader className="flex flex-row items-center justify-between">
                <div>
                  ...
                  <CardDescription>
                    Add and manage hackathons for the community.
                  </CardDescription>
                </div>
                <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
                  ...
                  <DialogContent className="sm:max-w-[525px]">
                    <DialogHeader>
                      ...
                      <DialogDescription>
                        Fill in the details for the hackathon. Click save when
                        you're done.
                      </DialogDescription>
                    </DialogHeader>
                    <form
